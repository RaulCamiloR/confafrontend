...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children }) => {
  ...
  const getStepTitle = () => {
    switch (currentStep) {
      case 1: return 'Crear nuevo segmento';
      case 2: return 'Subir archivo de contactos';
      case 3: return 'Confirmar y procesar';
      case 4: return 'Carga exitosa';
      default: return title || 'Subir contactos';
    }
  };
    ...
    switch (currentStep) {
      case 1:
        return (
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="channelType" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Tipo de canal
              </label>
              <select
                id="channelType"
      ...
      case 2:
        return (
          <div className="space-y-4">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Sube el archivo Excel con los contactos para el segmento <span className="font-semibold">{uniqueSegmentName}</span>
            </p>
        ...
        return (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-3">
              <div>
                <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Detalles del segmento</h4>
                <div className="mt-1 p-2 border border-gray-200 dark:border-gray-600 rounded-md">
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    <span className="font-semibold">Nombre del segmento:</span> {uniqueSegmentName}
                  </p>
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    <span className="font-semibold">Tipo de canal:</span> {channelType}
                  </p>
                </div>
              </div>
              
              <div>
                <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Archivo seleccionado</h4>
