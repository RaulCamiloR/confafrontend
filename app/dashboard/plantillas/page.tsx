...
import { templateConstants } from './constants/plantillas'
...
const PlantillasPage = () => {
  ...
  const [editorType, setEditorType] = useState<TemplateType>('EMAIL')
          ...
          <div className="flex items-center justify-center mt-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-2 text-center text-gray-800 dark:text-white">Template de Email</h3>
                <p className="text-gray-600 dark:text-gray-300 text-center">Crea una plantilla de email con editor visual</p>
              </div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-2 text-center text-gray-800 dark:text-white">Template de SMS</h3>
                <p className="text-gray-600 dark:text-gray-300 text-center">Crea una plantilla de texto para SMS</p>
              </div>
            </div>
          </div>
        </div>
